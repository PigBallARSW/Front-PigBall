...
export default function RoomList({sampleRooms}) {
                  ...
                  <ListItemText
                    primary={
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        {room.isPrivate && <Lock fontSize="small" sx={{ color: "rgba(255, 255, 255, 0.7)", fontSize: 16 }} />}
                      </Box>
                    }
                    secondary={
                      <Box sx={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", mt: 0.5, flexWrap: "wrap" }}>
                          <Chip
                            label={`${room.players}/${room.maxPlayers}`}
                            size="small"
